...
class RulePortfolioTrainer(Trainer):
    def __init__(self,
                 config = None,
                 dataset=None,
                 metrics = None,
        ...
        super(RulePortfolioTrainer, self).__init__(**kwargs)
    ...
    def train(self):
        logger.warning("RuleAgentTrainer does not support train method. Please use valid instead.")
    ...
    def inference(self, environment = None, mode: str = "valid"):
        ...
        original_prices_dfs = data["original_prices_dfs"]
        actions = self.agent.forward(original_prices_dfs)
