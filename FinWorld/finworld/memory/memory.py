...
from finworld.models import ChatMessage, MessageRole
from finworld.exception import AgentError
from finworld.utils import make_json_serializable
from finworld.log import LogLevel, Timing, TokenUsage
...
class AgentMemory:
    ...
    def replay(self, logger: Any, detailed: bool = False):
