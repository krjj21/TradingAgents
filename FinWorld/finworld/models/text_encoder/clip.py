...
class ClipTextEncoder:
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.embed_dim = self.text_encoder.transformer.config.hidden_size

        if frozen:
            requires_grad(self.text_encoder, False)

    def __str__(self):
        str = f"ClipTextEncoder from pretrained model: {self.text_encoder.transformer.config.model_type}.\n"
    ...
    def encode(self, text):
        ...
        embeding = pooled_embeddings.unsqueeze(1).unsqueeze(1)
        return embeding
