...
class AggDataEmbed(Embed):
    """Aggregated Data embedding module. Mainly used for tabular data.
    ...
    def __init__(self, *args,
        ...
        super(AggDataEmbed, self).__init__(*args, **kwargs)
...
if __name__ == '__main__':
    ...
    dense_features = torch.randn(batch_size, seq_len, num_asset, input_dim)  # Batch size of 4, 10 time steps, 64 features
