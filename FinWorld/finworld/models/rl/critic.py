...
if __name__ == "__main__":
    ...
    a = torch.randint(0, 3, (batch_size, 1)).to(device)
    output = critic(x, a)
    print("Output shape:", output.shape)
    ...
    output = critic(x)
    print("Output shape:", output.shape)
    a = torch.randint(0, 3, (batch_size, num_envs, 1)).to(device)
    output = critic(x, a)
    print("Output shape:", output.shape)
    ...
    output = critic(x)
    print("Output shape:", output.shape)
    a = torch.randn(batch_size, num_assets + 1).to(device) # 0 for cash
    output = critic(x, a)
    print("Output shape:", output.shape)
    ...
    output = critic(x)
    print("Output shape:", output.shape)
    a = torch.randn(batch_size, num_envs, num_assets + 1).to(device) # 0 for cash
    output = critic(x, a)
    print("Output shape:", output.shape)