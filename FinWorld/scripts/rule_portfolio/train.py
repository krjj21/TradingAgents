...
def parse_args():
    ...
    parser.add_argument("--config", default=os.path.join(root, "configs", "rule_portfolio", "buy_and_hold", "hs300_buy_and_hold_portfolio.py"), help="config file path")
...
def main():
    ...
    assert not args.train and args.test, "Only test mode is supported for now in rule portfolio."
