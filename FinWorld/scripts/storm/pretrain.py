...
def parse_args():
    ...
    parser.add_argument("--config", default=os.path.join(root, "configs", "storm", "pretrain", "dj30_dynamic_dual_vqvae_pretrain.py"), help="config file path")
...
if __name__ == '__main__':
    ...
    """
    CUDA_VISIBLE_DEVICES=4,5 torchrun --master_port=29510 --nproc_per_node=2 scripts/storm/pretrain.py --config configs/storm/pretrain/dj30_dynamic_dual_vqvae_pretrain.py
    """