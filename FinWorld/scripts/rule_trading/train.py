...
def parse_args():
    ...
    parser.add_argument("--config", default=os.path.join(root, "configs", "rule_trading", "macd", "AAPL_macd_trading.py"), help="config file path")
...
def main():
    ...
    assert not args.train and args.test, "Only test mode is supported for now in rule trading."
