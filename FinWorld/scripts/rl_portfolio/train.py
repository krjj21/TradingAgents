...
def parse_args():
    ...
    parser.add_argument("--config", default=os.path.join(root, "configs", "rl_portfolio", "ppo","exp_ppo_portfolio.py"), help="config file path")
...
if __name__ == '__main__':
    ...
    """
    CUDA_VISIBLE_DEVICES=0 python scripts/rl_portfolio/train.py --config=configs/rl_portfolio/ppo/exp_ppo_portfolio.py
    """