...
split_timestamp = "2024-05-01"
num_assets = 256 # number of assets in the portfolio
if_norm = True
...
position_num_bins = 1000
position_max_value = int(1e6)
...
embedding_dim = 256
dropout = .0
num_max_tokens = position_num_bins
num_heads = 4
depth = 4
...
transition = indicator_transition + times_transition + policy_trading_transition + training_transition
...
environment = dict(
    ...
    position_num_bins=position_num_bins,
