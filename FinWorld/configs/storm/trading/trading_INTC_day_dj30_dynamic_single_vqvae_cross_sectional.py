select_asset = "INTC"
workdir = "workdir"
tag = f"trading_{select_asset}_day_dj30_dynamic_single_vqvae_cross_sectional"
...
dataset = dict(
    ...
    states_path="workdir/pretrain_day_dj30_dynamic_single_vqvae_cross_sectional/state.joblib",
